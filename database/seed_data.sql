-- =============================================================================
-- MySQL 8.0 DML Seed Data Script for SmartHR Corporate Portal
-- Currency: ₹ INR | Names: Indian Enterprise Staff
-- =============================================================================
...
(4, 2, 'HashiCorp Certified Terraform Associate', 'HashiCorp', '2024-08-14', 'TA-55104', 'ACTIVE')
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);

-- Achievements
INSERT INTO `achievements` (`id`, `employee_id`, `title`, `badge`, `category`, `awarded_by`, `awarded_date`, `notes`) VALUES
(1, 1, 'Sprint MVP Q2 2026 🏆', 'MVP', 'PERFORMANCE', 'Engineering Leadership', '2026-06-30', 'Delivered core microservices API migration 3 days ahead of deadline.'),
(2, 2, 'Innovation Star 🌟', 'STAR', 'INNOVATION', 'CTO Office', '2026-05-15', 'Designed high-throughput Kafka streaming pipeline for real-time telemetry.')
