...
export const DeadlineCountdown: React.FC<DeadlineCountdownProps> = ({
  ...
  if (timeLeft.isOverdue) {
    return (
      <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-bold font-mono bg-rose-100 text-rose-800 dark:bg-rose-950/80 dark:text-rose-300 border border-rose-300 dark:border-rose-800 animate-pulse ${className}`}>
  ...
  if (timeLeft.days <= 2) {
    return (
      <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-bold font-mono bg-amber-100 text-amber-900 dark:bg-amber-950/80 dark:text-amber-300 border border-amber-300 dark:border-amber-800 ${className}`}>
  ...
  // Normal: > 2 days
  return (
    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-semibold font-mono bg-emerald-50 text-emerald-800 dark:bg-slate-900 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-900/60 ${className}`}>
