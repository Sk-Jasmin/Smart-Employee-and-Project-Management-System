  ...
  return (
    <Card>
      ...
      <CardBody className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-12 text-xs uppercase font-bold text-slate-400 border-b border-slate-200 dark:border-slate-800 pb-2">
            ...
            return (
              <div key={proj.id} className="grid grid-cols-12 items-center text-xs gap-2">
                ...
                <div className="col-span-8 bg-slate-100 dark:bg-slate-800/60 h-6 rounded relative overflow-hidden flex items-center px-2">
                  <div
                    className={`h-4 rounded text-xs font-bold text-white flex items-center px-2 shadow-2xs transition-all duration-150 ${
