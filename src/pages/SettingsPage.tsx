      ...
      <Card>
        ...
        <CardBody className="p-4 flex items-center justify-between text-xs">
          <div>
            ...
            <p className="text-slate-500 text-xs mt-0.5">Press <kbd className="font-mono font-bold bg-slate-200 dark:bg-slate-800 px-1 py-0.5 rounded">Ctrl+K</kbd> to open Global Search, <kbd className="font-mono font-bold bg-slate-200 dark:bg-slate-800 px-1 py-0.5 rounded">Ctrl+B</kbd> for Bookmarks, or <kbd className="font-mono font-bold bg-slate-200 dark:bg-slate-800 px-1 py-0.5 rounded">?</kbd> for help.</p>
          </div>
