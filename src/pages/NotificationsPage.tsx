          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
            <label className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 cursor-pointer">
              ...
              <div>
                ...
                <span className="text-xs text-slate-500">Notify when assigned a task</span>
              </div>
            </label>
            ...
            <label className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 cursor-pointer">
              ...
              <div>
                ...
                <span className="text-xs text-slate-500">Notify on leave status update</span>
              </div>
            </label>
            ...
            <label className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 cursor-pointer">
              ...
              <div>
                ...
                <span className="text-xs text-slate-500">Notify on project milestones</span>
              </div>
            </label>
            ...
            <label className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 cursor-pointer">
              ...
              <div>
                ...
                <span className="text-xs text-slate-500">Notify on password/role change</span>
              </div>
            </label>
          </div>
        </CardBody>
      ...
      {isEmailModalOpen && (
        ...
        >
          <form onSubmit={handleDispatchEmail} className="space-y-4 text-xs">
            ...
            <div className="p-3 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 font-mono text-xs">
