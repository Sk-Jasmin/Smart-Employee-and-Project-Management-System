      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            Monitor daily check-ins, check-outs, work hour tallies, and punctuality logs.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="bg-slate-900 text-white p-3 rounded-lg border border-slate-800 flex items-center gap-4 shadow-sm">
            <div className="text-xs">
              <span className="text-slate-400 text-xs block uppercase font-bold">Shift Clock</span>
