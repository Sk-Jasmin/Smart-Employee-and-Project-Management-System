          ...
          return (
            <div key={col.id} className="bg-[#f8f9fa] dark:bg-slate-900/60 p-3 rounded-lg border border-slate-200 dark:border-slate-800 flex flex-col h-full min-h-[500px]">
              ...
              <div className={`flex items-center justify-between pb-3 mb-3 border-b-2 ${col.color}`}>
                <h3 className="font-bold text-xs uppercase tracking-wider text-slate-800 dark:text-slate-200">{col.title}</h3>
                <span className="bg-slate-200/80 dark:bg-slate-800 text-slate-800 dark:text-slate-200 text-xs font-bold px-2 py-0.5 rounded-full">
                  {columnTasks.length}
                </span>
              </div>
                    ...
                    return (
                      <Card key={task.id} className="hover:shadow-md hover:border-blue-300 dark:hover:border-slate-700 transition-all duration-150">
                        <CardBody className="p-4 space-y-3">
                          ...
                          <h4 className="task-card-title text-slate-900 dark:text-slate-100 line-clamp-2" style={{ fontSize: '12px', lineHeight: '16px', fontWeight: 700 }}>{task.title}</h4>
                          <p className="text-[11px] text-slate-600 dark:text-slate-300 line-clamp-2">{task.description}</p>
                          ...
                          <div className="pt-2 border-t border-slate-100 dark:border-slate-800 flex flex-wrap items-center justify-between gap-1 text-[11px] text-slate-500 dark:text-slate-400">
                          ...
                          {currentRole !== 'EMPLOYEE' && (
                            <div className="pt-2 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                              ...
                              <select
                                ...
                                className="text-[11px] bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-1.5 py-0.5 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all duration-150"
                              >
                                <option value="TODO">To Do</option>
                                <option value="IN_PROGRESS">In Progress</option>
                                <option value="REVIEW">In Review</option>
