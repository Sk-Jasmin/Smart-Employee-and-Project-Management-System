...
import { Role, Project, Employee, Priority, ProjectStatus, TaskItem } from '../types';
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            Oversee active software engineering projects, capital budgets, and project specifications.
          </p>
        </div>
