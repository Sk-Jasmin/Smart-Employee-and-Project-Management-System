      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-base font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 text-indigo-600 dark:text-indigo-400" /> Enterprise Audit Logs & Telemetry
          </h1>
        ...
        >
          <div className="space-y-4 text-xs">
            <div className="grid grid-cols-2 gap-4 p-4 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 font-mono">
              <div>
                <span className="text-slate-400 uppercase font-bold block text-[10px]">Log Event ID</span>
                <span className="font-bold text-slate-900 dark:text-white">#{selectedLog.id}</span>
              </div>
              <div>
                <span className="text-slate-400 uppercase font-bold block text-[10px]">Action Category</span>
                <span className="font-bold text-indigo-600 dark:text-indigo-400">{selectedLog.action}</span>
              </div>
              <div>
                <span className="text-slate-400 uppercase font-bold block text-[10px]">Timestamp</span>
                <span className="text-slate-800 dark:text-slate-200">{selectedLog.timestamp}</span>
              </div>
              <div>
                <span className="text-slate-400 uppercase font-bold block text-[10px]">Origin IP</span>
                <span className="text-slate-800 dark:text-slate-200">{selectedLog.ipAddress}</span>
              </div>
              <div className="col-span-2">
                <span className="text-slate-400 uppercase font-bold block text-[10px]">Performed By</span>
            ...
            <div>
              ...
              <pre className="p-3 bg-slate-900 text-emerald-400 rounded border border-slate-800 font-mono text-[11px] overflow-x-auto">
{JSON.stringify({
  id: selectedLog.id,
