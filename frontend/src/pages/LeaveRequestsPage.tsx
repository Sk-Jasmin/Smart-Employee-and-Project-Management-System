      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-base font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
            <Calendar className="w-4 h-4 text-emerald-600 dark:text-emerald-500" /> Leave Management & Workflow
          </h1>
            ...
            <div className="space-y-4 relative before:absolute before:left-4 before:top-4 before:bottom-4 before:w-0.5 before:bg-slate-200 dark:before:bg-slate-800">
              ...
              <div className="flex items-start gap-4 relative">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 mt-0.5">Filed by applicant on {selectedLeaveForWorkflow.createdAt}</p>
