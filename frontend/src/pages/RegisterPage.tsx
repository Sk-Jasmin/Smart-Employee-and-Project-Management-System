        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl p-6 sm:p-8 transition-colors duration-200">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {formData.password && (
                <div className="sm:col-span-2 p-3 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800">
                  <div className="text-xs font-bold text-slate-700 dark:text-slate-200 mb-2">Password Requirements:</div>
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className={isLengthValid ? 'text-emerald-600 dark:text-emerald-400 font-semibold' : 'text-slate-400'}>
                      <CheckCircle2 className="w-3.5 h-3.5 inline mr-1" /> 8+ Characters
                    </div>
                    <div className={hasUpper ? 'text-emerald-600 dark:text-emerald-400 font-semibold' : 'text-slate-400'}>
                      <CheckCircle2 className="w-3.5 h-3.5 inline mr-1" /> Uppercase Letter
                    </div>
                    <div className={hasLower ? 'text-emerald-600 dark:text-emerald-400 font-semibold' : 'text-slate-400'}>
                      <CheckCircle2 className="w-3.5 h-3.5 inline mr-1" /> Lowercase Letter
                    </div>
                    <div className={hasNumber ? 'text-emerald-600 dark:text-emerald-400 font-semibold' : 'text-slate-400'}>
                      <CheckCircle2 className="w-3.5 h-3.5 inline mr-1" /> Number (0-9)
                    </div>
                    <div className={hasSpecial ? 'text-emerald-600 dark:text-emerald-400 font-semibold' : 'text-slate-400'}>
                      <CheckCircle2 className="w-3.5 h-3.5 inline mr-1" /> Special Character (@$!%*?&#)
                    </div>
                  </div>
                </div>
              )}
