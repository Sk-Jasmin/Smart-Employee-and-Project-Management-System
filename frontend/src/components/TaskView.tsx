          ...
          return (
            <div key={col.status} className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 border border-slate-200/80 dark:border-slate-800 space-y-3">
              <div className={`flex items-center justify-between pb-3 border-b-2 ${col.color}`}>
                <h3 className="font-bold text-xs text-slate-900 dark:text-white uppercase tracking-wider">{col.label}</h3>
              ...
              <div className="space-y-3 max-h-[600px] overflow-y-auto pr-1">
                {colTasks.map((t) => {
                  ...
                  return (
                    <div key={t.id} className="p-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-900">
                          {proj?.name || 'Project'}
                        </span>
                      ...
                      {t.remarks && (
                        <div className="p-2 bg-slate-50 dark:bg-slate-800/50 rounded-lg text-[10px] text-slate-500 dark:text-slate-400 italic">
                          "{t.remarks}"
                        </div>
                      )}
