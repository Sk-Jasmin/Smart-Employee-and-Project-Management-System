        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden md:block text-left">
              ...
              <div className="text-[10px] text-slate-500 dark:text-slate-400 font-medium capitalize mt-0.5">
          ...
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 p-2 z-50">
              <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-800">
                <p className="text-xs font-bold text-slate-900 dark:text-white">Role Switcher</p>
                <p className="text-[10px] text-slate-500 dark:text-slate-400">Select active permission level</p>
              </div>
              <div className="py-1 space-y-1">
                {(['ADMIN', 'MANAGER', 'EMPLOYEE'] as Role[]).map((r) => (
                  ...
                  >
                    <span>{r}</span>
                    {currentRole === r && <CheckCircle2 className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />}
                  </button>
                ))}
              </div>
