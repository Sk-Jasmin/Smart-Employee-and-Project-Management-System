...
export const CardHeader: React.FC<{
  ...
  return (
    <div className={`px-5 py-4 border-b border-slate-200 dark:border-slate-800/80 flex items-center justify-between bg-slate-100/80 dark:bg-slate-900/95 ${className}`}>
      <div className="font-extrabold text-slate-900 dark:text-slate-100 text-sm tracking-tight">{children}</div>
