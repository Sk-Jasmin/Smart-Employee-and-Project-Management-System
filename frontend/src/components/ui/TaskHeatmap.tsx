      ...
      <CardBody className="p-4 space-y-3">
        <div className="grid grid-cols-7 gap-1.5">
          {days.map((d) => (
            <div
              key={d.day}
              className={`h-7 rounded flex items-center justify-center text-[10px] font-bold font-mono transition-transform duration-150 hover:scale-110 cursor-pointer ${getIntensityColor(
                d.intensity
        ...
        <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 pt-2 border-t border-slate-200/80 dark:border-slate-800">
